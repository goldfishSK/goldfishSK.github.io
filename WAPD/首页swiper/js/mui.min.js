						...
						if(m) {
							...
							if(n.length > 0)
								...
								if(o) o.innerText = d.slideNumber + 1;
									...
									for(var p = m.querySelectorAll(".mui-control-item"), g = 0, h = p.length; h > g; g++) p[g].classList[g === d.slideNumber ? "add" : "remove"](j)
							}
						}
						b.stopPropagation()
					}
	...
	function(a, b) {
		...
		h.init = function() {
			...
			if(~e) {
				...
				if("webview" === this.type) ~this.shown.indexOf(a) ? plus.webview.show(a) : (plus.webview.show(a, this.options.show.aniShow, this.options.show.duration), this.shown.push(a));
			...
			if("number" == typeof a && (a = this.ids[a]), "webview" === this.type) plus.webview.hide(a, "auto");
			else if("iframe" === this.type) {
