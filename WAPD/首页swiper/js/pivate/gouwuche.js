...
$(".edit").click(function() {
	if(ok1 == false) {
		$(this).parents(".shop-group-item").find(".shop-info-text").css("width", "54%");
		$(this).parents(".shop-group-item").find(".shop-info-move").show();
		$(this).text("完成");
		ok1 = true;
		console.log(ok1);
	} else {
		$(this).parents(".shop-group-item").find(".shop-info-text").css("width", "auto");
		$(this).parents(".shop-group-item").find(".shop-info-move").hide();
		$(this).text("编辑");
		ok1 = false;
		console.log(ok1);
	}
...
//   删除
$(".shop-info-move").click(function() {

	if($(this).parents(".shop-group-item").find("li").length == 1) {
	...
	if($(".shop-group-item").length == 0) {
		...
		_a.innerText = "购物车里空空如也，快去购物吧!";
		_a.href = "http://www.quanmingwang.com/";
		_a.className = "kong";
		$(".shopping").append(_a);
	}
});